...
#' @param unit the filename of a specific ALMS unit to search
...
dailywtsNEW <- function(RFID, start=NULL, end=NULL, values=NULL, unit=NULL, username=NULL, password=NULL){
