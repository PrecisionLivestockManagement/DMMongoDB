...
add_stations <- function(stationname, lat, long, area=NULL, timezone=NULL, username=NULL, password=NULL){
  ...
  if(is.null(username)||is.null(password)){
    ...
    propertyinfo <- get_stations(stationname, username = username, password = password,
                                 fields = c("_id", "longitude", "latitude", "reports", "timezone", "stationname"))
