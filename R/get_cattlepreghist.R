...
#'
#' This function provides a search tool to retrieve cattle pregnancy history from the Cattle collection in the DataMuster MongoDB database. If you need assistance please email \email{info@@datamuster.net.au} to seek help or suggest improvements.
...
#' @return a list of cattle RFID numbers and associated cattle pregnancy history
...
get_cattlepreghist <- function(RFID, values = NULL, username = NULL, password = NULL){
