...
add_calvingdata <- function(MTag, calfMTag, property, foetalagedate = NULL, foetalage = NULL, estcalvingdate = NULL, calvingdate = NULL, multiples = NULL, username=NULL, password=NULL){
